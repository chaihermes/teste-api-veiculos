...
export default class Cadastro extends Component {
    ...
    handleCadastro(event){
        ...
        axios.post(api.veiculos, cadastro)
        .then(response => {
            historico.push('/')
        })
        // .catch(error => {
    ...
    render(){
        return(
            <section className="d-flex justify-content-center m-5">
                <form className="card col-lg-8 p-5"  onSubmit={this.handleCadastro} >
                        ...
                        <div className="form-group row">
                            <label htmlFor="ano" className="col-sm-4 col-form-label">Ano</label>
                            <div className="col-sm-8">
